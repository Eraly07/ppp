...
def _system_prompt_sim(scenario: str) -> str:
    ...
    base = (
        ...
        "4. 【ЕҢ МАҢЫЗДЫ】 Егер диалогта бұрын хабарлар болса, ҚАЙТАДАН СӘЛЕМДЕСПЕ.\n"
        "5. Егер пайдаланушы 4-6 саннан тұратын код жіберсе, оны қабылдап, диалогты аяқтауға шақыр.\n"
        "6. Жауаптарыңда 'Банк қауіпсіздік қызметкері' деп ҚАЙТАЛАМА.\n\n"
        f"Рөліңіз: {scenarios.get(scenario, scenarios['bank'])}\n"
